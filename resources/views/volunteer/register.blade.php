...
@section('title', 'Volunteer Registration - Narayan Seva Sansthan')
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-lg-row-fluid">
            ...
            <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                <!--begin::Image-->
                <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="{{ asset('assets/media/auth/login_vaulenteer.webp') }}" alt="" />
                <!--end::Image-->
                <!--begin::Title-->
            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" method="POST" action="{{ route('volunteer.register') }}">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <img src="{{ asset('assets/media/auth/logo.jpg') }}" alt="Narayan Seva Sansthan - Volunteer Program Logo" class="mb-3" />
                                <h1 class="text-gray-900 fw-bolder mb-3">Volunteer Registration</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                            ...
                            <!--begin::Heading-->
                            <!--begin::Sign up options-->
                            <!-- <div class="row g-3 mb-9">
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                    <img alt="Logo" src="{{ asset('assets/media/svg/brand-logos/google-icon.svg') }}" class="h-15px me-3" />Sign </div>
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                    <img alt="Logo" src="{{ asset('assets/media/svg/brand-logos/apple-black.svg') }}" class="theme-light-show h-15px me-3" />
                                    <img alt="Logo" src="{{ asset('assets/media/svg/brand-logos/apple-black-dark.svg') }}" class="theme-dark-show h-15px me-3" />Sign up with Apple</a>
                                </div>
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Mobile-->
                                <input type="text" placeholder="Mobile Number" name="mobile" autocomplete="off" class="form-control bg-transparent @error('mobile') is-invalid @enderror" value="{{ old('mobile') }}" />
                                @error('mobile')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <!--end::Mobile-->
                            ...
                            <a href="{{ route('volunteer.login') }}" class="link-primary">Sign in</a></div>
                            <!--end::Sign in-->
                        </form>
                        <!--end::Form-->
                    </div>
